...
var map = {
	"./board-playing/board-playing.module": [
		"./src/app/board-playing/board-playing.module.ts",
		"board-playing-board-playing-module"
	],
	"./choose-leader/choose-leader.module": [
...
/* harmony import */ var _main_home_main_home_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./main-home/main-home.component */ "./src/app/main-home/main-home.component.ts");
...
var routes = [
    ...
    { path: 'main', component: _main_home_main_home_component__WEBPACK_IMPORTED_MODULE_1__["MainHomeComponent"], canActivate: [_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]] },
...
var firebaseUiAuthConfig = {
    signInFlow: 'popup',
    signInOptions: [
        firebaseui_angular__WEBPACK_IMPORTED_MODULE_8__["firebase"].auth.EmailAuthProvider.PROVIDER_ID,
        firebaseui_angular__WEBPACK_IMPORTED_MODULE_8__["firebase"].auth.PhoneAuthProvider.PROVIDER_ID,
    ],
    tosUrl: '/terms',
    privacyPolicyUrl: '/privacy',
    credentialHelper: firebaseui_angular__WEBPACK_IMPORTED_MODULE_8__["firebaseui"].auth.CredentialHelper.NONE,
};
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_9__["AppComponent"], _main_home_main_home_component__WEBPACK_IMPORTED_MODULE_1__["MainHomeComponent"]],
            entryComponents: [],
            imports: [
...
module.exports = "<ion-header>\n  <ion-toolbar color=\"secondary\">\n    <ion-title>\n      Count Point Game\n    </ion-title>\n\n    <ion-button size=\"small\" slot=\"end\" *ngIf=\"afAuth.auth.currentUser\" (click)=\"signOut()\">\n      <ion-icon name=\"log-out\"></ion-icon>\n    </ion-button>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding *ngIf=\"afAuth.auth.currentUser\">\n  <h5>\n    Welcome <strong>{{userName}} !</strong>\n  </h5>\n  <ion-label class=\"ion-text-center\">CHOOSE YOUR GAME</ion-label>\n  <ion-grid>\n    <ion-row>\n      <ion-col (click)=\"onChooseTypeGame('1')\" size=\"4\">\n        <ion-img src=\"./../../assets/tienlen.png\"></ion-img>\n        <ion-card-subtitle padding class=\"ion-text-center\">TIEN LEN</ion-card-subtitle>\n      </ion-col>\n      <ion-col (click)=\"onChooseTypeGame('2')\" size=\"4\">\n        <ion-img src=\"./../../assets/tienlen.png\"></ion-img>\n        <ion-card-subtitle padding class=\"ion-text-center\">XI DACH</ion-card-subtitle>\n      </ion-col>\n      <ion-col (click)=\"onChooseTypeGame('3')\" size=\"4\">\n        <ion-img src=\"./../../assets/tienlen.png\"></ion-img>\n        <ion-card-subtitle padding class=\"ion-text-center\">DIEM</ion-card-subtitle>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n  <ion-fab vertical=\"bottom\" horizontal=\"end\" slot=\"fixed\">\n    <ion-fab-button>\n      <ion-icon name=\"add-circle-outline\"></ion-icon>\n    </ion-fab-button>\n    <ion-fab-list side=\"top\">\n      <ion-fab-button>\n        <ion-icon name=\"person\"></ion-icon>\n      </ion-fab-button>\n    </ion-fab-list>\n    <ion-fab-list side=\"start\">\n      <ion-fab-button>\n        <ion-icon name=\"bookmark\"></ion-icon>\n      </ion-fab-button>\n    </ion-fab-list>\n  </ion-fab>\n</ion-content>"

/***/ }),

/***/ "./src/app/main-home/main-home.component.scss":
/*!****************************************************!*\
  !*** ./src/app/main-home/main-home.component.scss ***!
  \****************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21haW4taG9tZS9tYWluLWhvbWUuY29tcG9uZW50LnNjc3MifQ== */"
...
var MainHomeComponent = /** @class */ (function () {
    function MainHomeComponent(usersv, afAuth, router, gamesv) {
        this.usersv = usersv;
        this.afAuth = afAuth;
        this.router = router;
        this.gamesv = gamesv;
    ...
    MainHomeComponent.prototype.signOut = function () {
        var _this = this;
        this.afAuth.auth.signOut().then(function () {
            _this.router.navigate(['/home']);
        });
    };
    MainHomeComponent.prototype.onChooseTypeGame = function (typeGame) {
    ...
    MainHomeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./main-home.component.scss */ "./src/app/main-home/main-home.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _services_game_service__WEBPACK_IMPORTED_MODULE_5__["GameService"]])
    ], MainHomeComponent);
...
var GameService = /** @class */ (function () {
    function GameService() {
        this.typeGameInit = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]('1');
        this.typeGame = this.typeGameInit.asObservable();
    }
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.reAuth = function (username, password) {
        return this.afAuth.auth.currentUser.reauthenticateWithCredential(firebase_app__WEBPACK_IMPORTED_MODULE_4__["auth"].EmailAuthProvider.credential(username, password));
    };
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.user)
                            return [2 /*return*/, true];
                        return [4 /*yield*/, this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).toPromise()];
                    case 1:
                        user = _a.sent();
                        if (user) {
                            this.setUser({
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyBgBaFKT6kv9MYUe9GKyyaTxOZPFbTCZpo",
        authDomain: "hihihi-42b7b.firebaseapp.com",
        databaseURL: "https://hihihi-42b7b.firebaseio.com",
        projectId: "hihihi-42b7b",
        storageBucket: "hihihi-42b7b.appspot.com",
        messagingSenderId: "987940131116"
    }
};
/*
...
module.exports = __webpack_require__(/*! /Volumes/Data/myCode/countPointGame/src/main.ts */"./src/main.ts");
